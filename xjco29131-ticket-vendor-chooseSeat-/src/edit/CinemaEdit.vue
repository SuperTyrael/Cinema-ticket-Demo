<template>
  ...
  <v-container>
    ...
    <v-row>
      <v-col>
        <!-- Seat system  -->
        <div id="bg" style="display: flex; min-height: 30rem ; width: 100%; justify-content: center; align-items: center">
      ...
      <v-col>
        ...
        <v-row>
          <v-col><h4>Height: </h4>{{height}}</v-col>
        </v-row>
        <v-row>
          <v-col><h4>Width: </h4>{{width}}</v-col>
        </v-row>

        <v-row>
          <v-col><h4>Seats: </h4>{{numSeats}}</v-col>
        </v-row>
        <v-row>
          <v-col><h4>VIP: </h4>{{numVIP}}</v-col>
        </v-row>
      </v-col>
    </v-row>
  </v-container>
